...
conv = partial(slim.conv2d, activation_fn=None, weights_initializer=tf.compat.v1.truncated_normal_initializer(stddev=0.02))
dconv = partial(slim.conv2d_transpose, activation_fn=None, weights_initializer=tf.compat.v1.random_normal_initializer(stddev=0.02))
fc = partial(ops.flatten_fully_connected, activation_fn=None, weights_initializer=tf.compat.v1.random_normal_initializer(stddev=0.02))
relu = tf.nn.relu
